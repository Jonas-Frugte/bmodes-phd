...
\section{Galaxy shape $B$-modes, theoretical model}

\subsection{$B$-modes due to intrinsic alignment}


\subsection{Lensing corrections (post-Born)}


\subsection{$B$-modes due to galaxy clustering}
...
\subsection{$B$-modes due to flux / size cutoffs and lensing}
...
\section{Simulating/modelling nonlinear structure formation and baryonic feedback with HMCODE}
...
\subsection{Optimizing the halo model and taking into account baryonic feedback}
